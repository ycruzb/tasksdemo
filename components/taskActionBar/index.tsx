...
const TaskActionBar = ({ show, taskContent = "", emptyTaskContent }: IProps) => {
	...
	return (
		<div className={parentClasses}>
			...
			<div className="flex space-x-1">
				<div className="hidden lg:flex space-x-1 desktop">
				...
				<div className="flex lg:hidden mobile">
					<CustomButtom type="primary" icon={taskContent !== "" ? <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
					</svg> : <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
					</svg>} text="" action={addTaskHandle} />
				</div>
			</div>
		</div>
	)
